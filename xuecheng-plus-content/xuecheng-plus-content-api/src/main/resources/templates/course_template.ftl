                        ...
                        <div class="content">
                            <div class="item">
                                ...
                                <div class="drop-down" style="height: 260px;">
                                    <ul class="list-box">
                                        <li class="active"><a href="http://www.51xuecheng.cn/course/preview/learning.html?id=${model.courseBase.id}&chapter=149" target=_blank>1.1 阅读：分级政策细节</a> <span>97’33”</span></li>
